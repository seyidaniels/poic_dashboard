        ...
        <div v-if="team.name" class="row justify-content-center">
          <div class="col-12 col-lg-10 col-xl-8">
            ...
            <div class="header mt-md-5">
              <div class="header-body">
                <div class="row align-items-center">
                  ...
                  <div class="col-auto">
                    <a @click="leaveTeam" class="btn btn-primary ml-2">
                      Leave Team
                    </a>
            ...
            <div  class="card card-body p-5">
                ...
                <img :src="team.image"  alt="..." class="img-fluid mt-5 mb-4" style="max-width: 272px;">
              ...
              <div class="card-body text-center">
                <div class="row justify-content-center">
                  <div class="col-12 col-xl-10">
                    ...
                    <img src="https://image.flaticon.com/icons/svg/1410/1410245.svg"  alt="..." class="img-fluid mt--5 mb-4" style="max-width: 272px;">
                    ...
                    <p class="text-muted">
                      You can be a part of a team by creating one or asking another registered member to add your email
                    </p>
...
export default {
    ...
    mounted() {
        axios.get(this.$store.state.serverURI + 'get-team').then (response => {
