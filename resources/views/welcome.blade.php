...
@section('content')
 ...
 <div class="wrapper">
        ...
        <div class="swiper-wrapper">
            ...
            <div class="image image-overlay image-zoom" style="background-image:url(/landing/assets/newassets/img/POIC_PICS/DSC_3321.jpg)"></div>
            <div class="container">
            ...
            <div class="swiper-slide">
            <div class="image image-overlay image-zoom" style="background-image:url(/landing/assets/newassets/img/POIC_PICS/DSC_3274.jpg)"></div>
            <div class="container">
            ...
            <div class="swiper-slide">
            <div class="image image-overlay image-zoom" style="background-image:url(/landing/assets/newassets/img/POIC_PICS/DSC_3252.jpg)"></div>
            <div class="container">
                <div class="row align-items-center vh-100">
                <div class="col-lg-8 text-white" data-swiper-parallax-x="-100%">
                    <h1 class="display-1 mt-1 mb-3 font-weight-light">Professor Ogundipe Innovative Challenge.</h1>
        ...
        <div class="swiper-footer">
            ...
            <div class="row align-items-center mb-5">
                ...
                <div class="swiper-navigation">
                    ...
                    style="-webkit-transition: all 0.2s;
    ...
    <section class="about-poic">
        <div class="container">
            ...
            <div class="col-md-5 pr-xl-4 mb-4 md-mb-0 order-lg-1">
                <h1 class="display-3 mb-3 mt-3 mt-lg-0" style="font-weight: 700;color: #121212!important;">About <span class="link-1">POIC</span></h1>
                <p class="text-justify">
                Over the years, in a bid to make sure their idea come to life, Nigerian students become outbound thereby sourcing out
                their potentials. A staggering amount of 170,000+ students Left the country between year 2015-2018.
                </p>
                <div class="mb-3"></div>
        ...
        <div class="container d-flex text-lg-left">
            ...
            <div class="row row-grid ">
                ...
                <p class="text-muted text-sm mb-0">Lorem ipsum dolor sit amet consectetur adipisicing elit. Eos molestias similique totam repellat repellendus, minus harum assumenda perspiciatis atque cupiditate iure id praesentium consequuntur. Adipisci alias consectetur deleniti dicta odit.</p>
                <div class="mb-3"></div>
                <a href="#" class="hover-arrow">
                    Read More
                    <span>
                ...
                <div class="row mx-n2 my-mt-lg-0 my-mt-5">
                    ...
                    <div class="card mb-3">
                        ...
                        <p class="text-muted text-sm mb-0">Lorem ipsum dolor sit amet consectetur adipisicing elit.</p>
                        </div>
                    </div>
                    <div class="card">
                        <div class="card-body py-5 h-100 cardi-b">
        ...
        <div class="container">
            ...
            <div class="col-xl-5 col-md-6">
                ...
                <svg xmlns="http://www.w3.org/2000/svg" width="43" height="122" viewBox="0 0 43 122" fill="none" class="injected-svg bg-primary-2"
                    data-src="/landing/assets/newassets/img/decorations/deco-blob-13.svg" xmlns:xlink="http://www.w3.org/1999/xlink">
                ...
                <svg xmlns="http://www.w3.org/2000/svg" width="110" height="116" viewBox="0 0 110 116" fill="none" class="injected-svg bg-primary"
                    data-src="/landing/assets/newassets/img/decorations/deco-dots-3.svg" xmlns:xlink="http://www.w3.org/1999/xlink">
            ...
            <div class="col-md-5 pr-xl-4 mb-4 mb-md-0">
                <h3 class="mb-3 my-mt-lg-0 my-mt-5" style="font-weight: 700;color: #b78743!important;">"Who is Professor Ogundipe?"</h3>
                ...
                <p class="text-justify">He is the 12th Vice-Chancellor of University of Lagos. He attended the University of Ife (now Obafemi Awolowo
                University) where he obtained a Bachelor of science (B.Sc.) degree in Botany. He holds a master's degree in Botany from
        ...
        <div class="container">
            ...
            <div class="col-md-6 col-lg-8">
                <div class="owl-carousel owl-carousel-alt visible owl-loaded owl-drag" data-items="[2,2,1,1]" data-margin="10"
                data-loop="true" data-nav="true">
                <div class="owl-stage-outer">
                    <div class="owl-stage" style="transform: translate3d(-1149px, 0px, 0px); transition: all 0.4s ease 0s; width: 4217px;">
                    <div class="owl-item cloned" style="width: 373.328px; margin-right: 10px;">
                        <figure class="equal"><a class="image image-fade" href="#!" style="background-image: url(/landing/assets/newassets/img/POIC_PICS/DSC_3355.jpg)"></a></figure>
                    </div>
                    <div class="owl-item cloned" style="width: 373.328px; margin-right: 10px;">
                        <figure class="equal"><a class="image image-fade" href="#!" style="background-image: url(/landing/assets/newassets/img/POIC_PICS/DSC_3341.jpg)"></a></figure>
                    </div>
                    <div class="owl-item cloned" style="width: 373.328px; margin-right: 10px;">
                        <figure class="equal"><a class="image image-fade" href="#!" style="background-image: url(/landing/assets/newassets/img/POIC_PICS/DSC_3339.jpg)"></a></figure>
                    </div>
                    <div class="owl-item active" style="width: 373.328px; margin-right: 10px;">
                        <figure class="equal"><a class="image image-fade" href="#!" style="background-image: url(/landing/assets/newassets/img/POIC_PICS/DSC_3325.jpg)"></a></figure>
                    </div>
                    <div class="owl-item active" style="width: 373.328px; margin-right: 10px;">
                        <figure class="equal"><a class="image image-fade" href="#!" style="background-image: url(/landing/assets/newassets/img/POIC_PICS/DSC_3327.jpg)"></a></figure>
                    </div>
                    <div class="owl-item" style="width: 373.328px; margin-right: 10px;">
                        <figure class="equal"><a class="image image-fade" href="#!" style="background-image: url(/landing/assets/newassets/img/POIC_PICS/DSC_3328.jpg)"></a></figure>
                    </div>
                    <div class="owl-item" style="width: 373.328px; margin-right: 10px;">
                        <figure class="equal"><a class="image image-fade" href="#!" style="background-image: url(/landing/assets/newassets/img/POIC_PICS/DSC_3283.jpg)"></a></figure>
                    </div>
                    <div class="owl-item" style="width: 373.328px; margin-right: 10px;">
                        <figure class="equal"><a class="image image-fade" href="#!" style="background-image: url(/landing/assets/newassets/img/POIC_PICS/DSC_3279.jpg)"></a></figure>
                    </div>
                    <div class="owl-item cloned" style="width: 373.328px; margin-right: 10px;">
                        <figure class="equal"><a class="image image-fade" href="#!" style="background-image: url(/landing/assets/newassets/img/POIC_PICS/DSC_3249.jpg)"></a></figure>
                    </div>
                    <div class="owl-item cloned" style="width: 373.328px; margin-right: 10px;">
                        <figure class="equal"><a class="image image-fade" href="#!" style="background-image: url(/landing/assets/newassets/img/POIC_PICS/DSC_3191.jpg)"></a></figure>
                    </div>
                    <div class="owl-item cloned" style="width: 373.328px; margin-right: 10px;">
                        <figure class="equal"><a class="image image-fade" href="#!" style="background-image: url(/landing/assets/newassets/img/POIC_PICS/DSC_3187.jpg)"></a></figure>
                    </div>
                    </div>
                </div>
                <div class="owl-nav">
            ...
            <div class="col">
                ...
                <li class="mx-xl-4 mx-3 mb-5 aos-init aos-animate" data-aos="fade-up" data-aos-delay="200">
                    ...
                    <path d="M42.8475 14.0442C42.8475 10.4894 45.443 8.00725 50.1598 8.00725C53.0378 8.00725 55.3928 8.92485 56.6687 9.82373C56.8513 9.95208 57.177 10.2635 56.9817 10.8426C56.7314 11.4663 56.2723 12.4043 55.943 13.0136C55.7512 13.3687 55.2616 13.3219 55.0108 13.195C54.102 12.7351 52.6114 11.9571 51.242 11.8137C50.8953 11.776 50.5464 11.7609 50.1977 11.7686C48.9917 11.7954 47.9842 12.2136 47.6294 13.1324C47.5598 13.3062 47.5211 13.4908 47.5148 13.6779C47.4816 14.8886 49.169 15.3264 51.2132 15.6772C55.0135 16.3273 57.8886 17.4399 57.8886 21.3459C57.8886 24.6629 55.2487 27.6606 50.0762 27.5687C46.6663 27.4999 44.2471 26.3493 42.9508 25.2329C42.9066 25.195 42.4131 24.6931 42.6776 24.0895C42.9803 23.3125 43.4913 22.422 43.8923 21.9492C44.1152 21.6455 44.7035 21.5973 45.0094 21.7865C46.0779 22.4496 47.8365 23.5128 49.8636 23.5834C50.0236 23.5889 50.1821 23.5898 50.3378 23.5858C52.1612 23.5416 53.2643 22.8512 53.2413 21.6882C53.2216 20.6636 51.7758 20.0651 49.4737 19.6318C45.8019 18.9412 42.848 17.7326 42.848 14.0442H42.8475ZM76.2049 19.1057C73.6156 19.1396 71.2416 19.8463 71.1732 21.8669C71.1724 23.4704 72.475 24.2579 74.3032 24.1548C76.0569 23.9861 77.3943 23.2266 77.9836 22.2188C78.2015 21.8453 78.2346 20.4477 78.2214 19.8504C78.2181 19.7232 77.9663 19.4826 77.856 19.4363C77.3059 19.2048 76.8987 19.1333 76.2046 19.1052L76.2049 19.1057ZM67.5893 10.9637C68.8001 9.88179 71.
0.0561943 102.549 0.287213 102.529 0.482487C102.343 3.30269 102.609 24.0051 102.72 26.9011C102.728 27.1105 102.884 27.2729 103.083 27.2847C103.891 27.3315 105.891 27.3283 106.824 27.3108C107.284 27.3108 107.34 26.9884 107.34 26.9884L107.409 21.4332C107.409 21.4332 107.456 21.1861 107.533 21.1045C107.862 20.7507 108.773 19.7762 109.161 19.3996C109.254 19.3092 109.401 19.3156 109.496 19.4435C109.957 20.0648 111.273 22.0847 112.492 23.8887C113.612 25.5459 114.658 27.0167 114.731 27.1206C114.9 27.3605 115.097 27.3701 115.245 27.3655V27.3648H115.245ZM60.6554 27.3456C60.9377 27.355 63.0794 27.3526 64.0283 27.3514C64.3478 27.3576 64.5138 27.116 64.5244 26.9028C64.726 22.8423 64.6397 3.51019 64.5124 0.457538C64.5018 0.193654 64.3887 0.0945778 64.2083 0.0705884C63.3939 -0.0383237 61.0794 -0.0128951 60.3376 0.18094C60.1925 0.218603 60.107 0.328714 60.1024 0.470252C59.9208 8.33879 60.0433 26.4796 60.0817 26.8231C60.1199 27.1671 60.3001 27.3336 60.6559 27.3456H60.6554V27.3456Z"
                        fill="#ADB5BD"></path>
                    <path d="M3.01795 19.1999C1.69499 19.21 0.574302 18.424 0.161088 17.1974C0.145759 17.151 0.131468 17.1044 0.118226 17.0574C-0.332072 15.4865 0.541072 13.8431 2.10604 13.3169L27.2071 4.93356C27.5051 4.84761 27.8136 4.8027 28.1238 4.80009C29.4819 4.78953 30.6335 5.59274 31.0568 6.84534L31.0943 6.96633C31.5639 8.60253 30.3972 10.063 28.9994 10.5311C28.9984 10.5318 28.7441 10.6175 4.0375 19.0268C3.7091 19.1384 3.36489 19.1968 3.01795 19.1999V19.1999Z"
                        fill="#ADB5BD"></path>
        ...
        <footer class="pb-4 bg-primary-3 o-hidden text-light" id="footer">
        <div class="container">
            <div class="row mb-5">
            <div class="col">
            ...
            <div class="col-sm-6 col-lg mt-3 mt-lg-0">
                <img src="/landing/assets/newassets/img/logo-white.png" alt="">
            </div>
            <div class="col-sm-6 col-lg-3 col-xl-2 mt-3 mt-lg-0">
                <h5>Navigate</h5>
            ...
            <!-- <div class="col-6 col-lg">
                ...
                <li class="mb-3 d-flex">
                    ...
                    viewBox="0 0 24 24" version="1.1" class="injected-svg icon" data-src="assets/img/icons/theme/map/marker-1.svg">
                ...
                <li class="mb-3 d-flex">
                    <svg xmlns="http://www.w3.org/2000/svg" xmlns:xlink="http://www.w3.org/1999/xlink" width="24px" height="24px"
                    viewBox="0 0 24 24" version="1.1" class="injected-svg icon" data-src="assets/img/icons/theme/communication/call-1.svg">
                ...
                <li class="mb-3 d-flex">
                    <svg xmlns="http://www.w3.org/2000/svg" xmlns:xlink="http://www.w3.org/1999/xlink" width="24px" height="24px"
                    viewBox="0 0 24 24" version="1.1" class="injected-svg icon" data-src="assets/img/icons/theme/communication/mail.svg">
            ...
            <div class="col col-md-auto text-center">
                <small class="text-muted">Copyright &copy; <span id="year"></span> All Rights Reserved.
                </small>
            </div>
            </div>
        </div>
