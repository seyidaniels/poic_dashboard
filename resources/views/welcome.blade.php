    ...
    <section class="about-poic">
        ...
        <div class="container d-flex text-lg-left">
            ...
            <div class="row row-grid ">
                ...
                <p class="text-muted text-sm mb-0">Professor Ogundipe Innovative Challenge is a science and technology competition which is set to reward technological innovations,
                        novel scientific concepts/ideas, redefined approach(es) to existing solutions to problems. POIC promotes entrepreneurship, technological revolution and improved economic outlook
                        </p>
                <div class="mb-3"></div>
                {{-- <a href="#" class="hover-arrow">
                    Read More
                ...
                <div class="row mx-n2 my-mt-lg-0 my-mt-5">
                    ...
                    <div class="card push-right">
                        ...
                        {{-- <h5 class="h6 mt-4 mb-1">4.95 out of 5 stars</h5> --}}
                        <p class="text-muted text-sm mb-0 text-obj">Rewards Novel Scientific Concepts/Ideas</p>
                        </div>
                    </div>
                    </div>
                    ...
                    <div class="card mb-3">
                        ...
                        {{-- <h5 class="h6 mt-4 mb-1">4.95 out of 5 stars</h5> --}}
                        <p class="text-muted text-sm mb-0 text-obj">Rewards Redefined Approach(es) to Existing Solutions to Problems
                            </p>
                        </div>
                    </div>
                    </div>
