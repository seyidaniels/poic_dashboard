...
<html lang="en" xmlns:v="urn:schemas-microsoft-com:vml" xmlns:o="urn:schemas-microsoft-com:office:office">
  <head>
    ...
    <style type="text/css">
      ...
      ::selection {color: #FFFFFF; background: ##121212;}
       #outlook a {padding: 0;}
    ...
    <table class="wrapper" align="center" bgcolor="#EEEEEE" cellpadding="0" cellspacing="0" width="100%">
      <tr>
        <td style="padding: 30px 0;">
          ...
          <!-- Header Left -->
          <table class="row" align="center" bgcolor="#121212" cellpadding="0" cellspacing="0">
            <tr>
            ...
            <tr>
              <th class="column" width="640" style="padding-left: 30px; padding-right: 30px; text-align: left;">
                <a href="http://example.com" style="text-decoration: none;">
                  <img class="mobile-center" src="http://poic.unilag.edu.ng/landing/assets/img/logo-white.png" width="105" alt="Header Logo" style="border: 0; width: 100%; max-width: 105px;">
                </a>
              </th>
            </tr>
            <tr>
          ...
          <table class="row" align="center" bgcolor="#F8F8F8" cellpadding="0" cellspacing="0">
            <tr>
                <th class="column" width="640" style="padding-left: 30px; padding-right: 30px; text-align: left;">
                    ...
                    <div style="color: #969AA1; font-size: 20px; margin-top: 40px;"><strong> {{date('l jS F Y')}} </strong></div>

                  </th>
            </tr>
            <tr>
              <td class="spacer" height="10" style="font-size: 80px; line-height: 80px; mso-line-height-rule: exactly;">&nbsp;</td>
            </tr>
            <tr>
              <th class="column" width="640" style="padding-left: 30px; padding-right: 30px; font-weight: 400; text-align: left;">
                ...
                <div class="sans-serif" style="color: #969AA1; font-size: 18px; line-height: 28px; margin-bottom: 40px;">{{$message}}</div>
                <table class="mobile-text-center" bgcolor="#B78743" cellpadding="0" cellspacing="0" style="border-radius: 3px;">
                  <tr>
                    <th class="sans-serif">
                    <a href="{{Config::get('app.url')}}/dashboard/#/project" style="border: 0 solid #B78743; color: #FFFFFF; display: inline-block; font-size: 14px; font-weight: 400; padding: 15px 50px 15px 50px; text-decoration: none;">View Project</a>
                    </th>
                  </tr>
                </table>
                  ...
                  <tr valign="top" style="vertical-align: top;">
                    <th class="column mobile-padding-bottom" width="255" style="padding-top: 10px; padding-right: 10px; text-align: left;">
                      <a href="http://example.com">
                        <img src="http://poic.unilag.edu.ng/landing/assets/img/logo-white.png" width="78" alt="Footer Logo" style="border: 0; width: 100%; max-width: 78px;">
                      </a>
                    </th>
                      ...
                      <table align="right" class="mobile-left" cellpadding="10" cellspacing="0">
                        <tr>
                          <td style="padding-left: 0;">
                            <a href="http://twitter.com/our_ulssa" style="text-decoration: none;">
                              <img src="https://ulssa.com.ng/email/images/icons/social/circle/twitter-circle.png" width="24" alt="Twitter" style="border: 0; width: 100%; max-width: 24px;">
                            </a>
                          </td>
                          <td>
                            <a href="http://facebook.com/ulssa_unified" style="text-decoration: none;">
                              <img src="https://ulssa.com.ng/email/images/icons/social/circle/facebook-circle.png" width="24" alt="Facebook" style="border: 0; width: 100%; max-width: 24px;">
                            </a>
                          </td>
                          <td style="padding-right: 0;">
                            <a href="http://instagram.com/our_ulssa" style="text-decoration: none;">
                              <img src="https://ulssa.com.ng/email/images/icons/social/circle/instagram-circle.png" width="24" alt="Google+" style="border: 0; width: 100%; max-width: 24px;">
                            </a>
                          </td>
                        </tr>
                      </table>
                ...
                <table class="row" cellpadding="0" cellspacing="0">
                  <tr>
                    <th class="column" width="640" style="color: #969AA1; font-weight: 400; text-align: left;">
                      <div class="sans-serif">&copy; ULSSA 2018/2019. All Rights Reserved.</a></div>
                    </th>
                  </tr>
                  <tr>
