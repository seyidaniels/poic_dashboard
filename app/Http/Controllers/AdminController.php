...
class AdminController extends Controller
{
    ...
    public function resendAdminInvite(Request $request)
    {
        DB::transaction(function () use ($request) {
            ...
            $admin->update();
            $admin['message'] = "You have been resent a password to login to POIC. Your password is ''" . $password . "''. Kindly log on to perform admin duties";
            $admin['subject'] = "New Invitation to access Projects";
            $admin->notify(new WelcomeAdmin($admin));
        });
        return response()->json(['success' => true, 'message' => 'Admin added']);
    }
