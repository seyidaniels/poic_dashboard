            ...
            <tr>
              <th class="column" width="640" style="padding-left: 30px; padding-right: 30px; font-weight: 400; text-align: left;">
                ...
                <table class="mobile-text-center" bgcolor="#B78743" cellpadding="0" cellspacing="0" style="border-radius: 3px;">
                  <tr>
                    <th class="sans-serif">
                    <a href="{{Config::get('app.url')}}/reset-password/{{$data['token']}}" style="border: 0 solid #B78743; color: #FFFFFF; display: inline-block; font-size: 14px; font-weight: 400; padding: 15px 50px 15px 50px; text-decoration: none;">Reset Password</a>
                    </th>
                  </tr>
                </table>
