                    ...
                    <div class="card-body">
                        <div class="row align-items-center">
                            ...
                            <div class="col ml--2">
                                ...
                                <p class="lead">
                                    Team Head: {{ $team->head->fullname() }} <br>
                                    Phone Number: {{ $team->head->phone }} <br>
                            ...
                            <div class="col-auto">
                                @if($team->project)
                                <!-- Button -->
                                <a href="/admin/dashboard/project/view/{{$team->project->id}}"
                            ...
                            <div class="col-auto">
                                ...
                                <div class="dropdown">
                                    ...
                                    <div class="dropdown-menu dropdown-menu-right">
                                        <a href="#!" data-toggle="modal" data-target="#modalMembers"
                                            data-team_id={{$team->id}} class="dropdown-item">
                                            Disqualifiy
                                        </a>
                                        <a href="#!" data-toggle="modal" data-target="#messageMembers"
                                            data-team_id={{$team->id}} class="dropdown-item">
                                            Message
                                        </a>
                                    </div>
